...
Thanks for looking. This package is small on purpose: it turns an MT101
...
ruff check pain001_loader_mt101/ tests/ examples/ benches/ scripts/
ruff format --check pain001_loader_mt101/ tests/ examples/ benches/ scripts/
mypy pain001_loader_mt101/
python benches/bench_parse_mt101.py --quick   # the benchmark still runs
```
...
`pain001_loader_mt101/__init__.py`. Change both, add a `CHANGELOG.md` entry,
