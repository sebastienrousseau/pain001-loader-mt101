...
# pain001-loader-mt101 Governance

This document describes how pain001-loader-mt101 is run, how decisions are made, and how
...
pain001-loader-mt101 is a loader plugin for the
[`pain001`](https://github.com/sebastienrousseau/pain001) ISO 20022
library. It parses legacy SWIFT MT101 Request for Transfer messages into
the flat records `pain001` validates and turns into `pain.001` XML.
...
1. Contribute a few reviewed PRs ([`ARCHITECTURE.md`](ARCHITECTURE.md) is
   the map; good first areas: a tag from the documented out-of-scope list, a fixture message, a benchmark).
...
pain001-loader-mt101 has **one** maintainer today. The mitigations in place:
